      ...
      <div className="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <h2 className="mt-2 text-2xl font-semibold text-gray-900">Acesse sua conta</h2>
            <p className="mt-2 text-gray-600">
              Entre para acessar sua conta e gerenciar suas licitações
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit}>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link 
                      to="/forgot-password" 
                      className="text-xs text-cotai-purple hover:underline"
                    >
                      Esqueceu a senha?
                    </Link>
                  </div>
              ...
              <CardFooter className="flex flex-col space-y-4">
                ...
                <div className="text-center text-sm">
                  ...
                  <Link to="/register" className="text-cotai-purple hover:underline">
                    Cadastre-se
                  </Link>
                </div>
              </CardFooter>
